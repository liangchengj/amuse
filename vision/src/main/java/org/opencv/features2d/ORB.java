...
public class ORB extends Feature2D {
    ...
    public static ORB create(int nfeatures, float scaleFactor, int nlevels,
        ...
        return ORB.__fromPtr__(create_0(
                nfeatures,
                scaleFactor,
                nlevels,
                edgeThreshold,
    ...
    public static ORB create(int nfeatures, float scaleFactor, int nlevels,
                             int edgeThreshold, int firstLevel, int WTA_K,
                             int scoreType) {
        return ORB.__fromPtr__(create_2(
                nfeatures,
                scaleFactor,
                nlevels,
                edgeThreshold,
    ...
    public static ORB create(int nfeatures, float scaleFactor, int nlevels,
                             int edgeThreshold, int firstLevel, int WTA_K) {
        return ORB.__fromPtr__(create_3(
                nfeatures,
                scaleFactor,
                nlevels,
                edgeThreshold,
    ...
    public static ORB create(int nfeatures, float scaleFactor, int nlevels,
        ...
        return ORB.__fromPtr__(create_4(
                nfeatures,
                scaleFactor,
                nlevels,
                edgeThreshold,
    ...
    // C++: static Ptr_ORB cv::ORB::create(int nfeatures = 500, float scaleFactor = 1.2f, int nlevels = 8, int edgeThreshold = 31, int firstLevel = 0, int WTA_K = 2, ORB_ScoreType scoreType = ORB::HARRIS_SCORE, int patchSize = 31, int fastThreshold = 20)
    private static native long create_0(int nfeatures, float scaleFactor, int nlevels,
                                        int edgeThreshold, int firstLevel, int WTA_K,
                                        int scoreType, int patchSize, int fastThreshold);

    private static native long create_1(int nfeatures, float scaleFactor, int nlevels,
                                        int edgeThreshold, int firstLevel, int WTA_K,
                                        int scoreType, int patchSize);

    private static native long create_2(int nfeatures, float scaleFactor, int nlevels,
                                        int edgeThreshold, int firstLevel, int WTA_K,
                                        int scoreType);

    private static native long create_3(int nfeatures, float scaleFactor, int nlevels,
                                        int edgeThreshold, int firstLevel, int WTA_K);

    private static native long create_4(int nfeatures, float scaleFactor, int nlevels,
                                        int edgeThreshold, int firstLevel);

    private static native long create_5(int nfeatures, float scaleFactor, int nlevels,
                                        int edgeThreshold);

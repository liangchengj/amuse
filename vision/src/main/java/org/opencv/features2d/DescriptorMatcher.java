...
public class DescriptorMatcher extends Algorithm {
    ...
    private static native void knnMatch_0(long nativeObj, long queryDescriptors_nativeObj,
                                          ...
                                          long matches_mat_nativeObj, int k, long mask_nativeObj,
    ...
    private static native void knnMatch_4(long nativeObj, long queryDescriptors_nativeObj,
                                          long matches_mat_nativeObj, int k,
                                          long masks_mat_nativeObj);

    private static native void knnMatch_5(long nativeObj, long queryDescriptors_nativeObj,
                                          long matches_mat_nativeObj, int k);

...
public class MSER extends Feature2D {
    ...
    public static MSER create(int _delta, int _min_area, int _max_area,
        ...
        return MSER.__fromPtr__(create_0(
                _delta,
                _min_area,
                _max_area,
                _max_variation,
    ...
    public static MSER create(int _delta, int _min_area, int _max_area,
        ...
        return MSER.__fromPtr__(create_2(
                _delta,
                _min_area,
                _max_area,
                _max_variation,
    ...
    public static MSER create(int _delta, int _min_area, int _max_area,
                              ...
                              int _max_evolution) {
        return MSER.__fromPtr__(create_3(
                _delta,
                _min_area,
                _max_area,
                _max_variation,
    ...
    public static MSER create(int _delta, int _min_area, int _max_area,
                              double _max_variation, double _min_diversity) {
        return MSER.__fromPtr__(create_4(
                _delta,
                _min_area,
                _max_area,
                _max_variation,
    ...
    // C++: static Ptr_MSER cv::MSER::create(int _delta = 5, int _min_area = 60, int _max_area = 14400, double _max_variation = 0.25, double _min_diversity = .2, int _max_evolution = 200, double _area_threshold = 1.01, double _min_margin = 0.003, int _edge_blur_size = 5)
    private static native long create_0(int _delta, int _min_area, int _max_area,
                                        double _max_variation, double _min_diversity,
                                        int _max_evolution, double _area_threshold,
                                        double _min_margin, int _edge_blur_size);

    private static native long create_1(int _delta, int _min_area, int _max_area,
                                        double _max_variation, double _min_diversity,
                                        int _max_evolution, double _area_threshold,
                                        double _min_margin);

    private static native long create_2(int _delta, int _min_area, int _max_area,
                                        double _max_variation, double _min_diversity,
                                        int _max_evolution, double _area_threshold);

    private static native long create_3(int _delta, int _min_area, int _max_area,
                                        double _max_variation, double _min_diversity,
                                        int _max_evolution);

    private static native long create_4(int _delta, int _min_area, int _max_area,
                                        double _max_variation, double _min_diversity);

    private static native long create_5(int _delta, int _min_area, int _max_area,
                                        double _max_variation);
    ...
    // C++:  void cv::MSER::detectRegions(Mat image, vector_vector_Point& msers, vector_Rect& bboxes)
    private static native void detectRegions_0(long nativeObj, long image_nativeObj,
                                               long msers_mat_nativeObj, long bboxes_mat_nativeObj);

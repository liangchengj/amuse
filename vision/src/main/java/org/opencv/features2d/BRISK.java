...
public class BRISK extends Feature2D {
     ...
     */
    public static BRISK create(int thresh, int octaves, MatOfFloat radiusList,
                               MatOfInt numberList, float dMax, float dMin,
                               MatOfInt indexChange) {
        Mat radiusList_mat = radiusList;
        Mat numberList_mat = numberList;
        Mat indexChange_mat = indexChange;
        return BRISK.__fromPtr__(create_0(
                thresh,
                octaves,
    ...
    public static BRISK create(int thresh, int octaves, MatOfFloat radiusList,
        ...
        Mat radiusList_mat = radiusList;
        Mat numberList_mat = numberList;
        return BRISK.__fromPtr__(create_1(
                thresh,
                octaves,
                radiusList_mat.nativeObj,
                numberList_mat.nativeObj,
     ...
     */
    public static BRISK create(int thresh, int octaves, MatOfFloat radiusList,
                               MatOfInt numberList, float dMax) {
        Mat radiusList_mat = radiusList;
        Mat numberList_mat = numberList;
        return BRISK.__fromPtr__(create_2(
                thresh,
                octaves,
                radiusList_mat.nativeObj,
                numberList_mat.nativeObj,
    ...
    public static BRISK create(MatOfFloat radiusList, MatOfInt numberList, float dMax,
        ...
        Mat numberList_mat = numberList;
        Mat indexChange_mat = indexChange;
        return BRISK.__fromPtr__(create_8(
                radiusList_mat.nativeObj,
                numberList_mat.nativeObj,
                dMax,
                dMin,
    ...
    public static BRISK create(MatOfFloat radiusList, MatOfInt numberList, float dMax,
        ...
        Mat radiusList_mat = radiusList;
        Mat numberList_mat = numberList;
        return BRISK.__fromPtr__(create_9(
                radiusList_mat.nativeObj,
                numberList_mat.nativeObj,
                dMax,
                dMin
    ...
    // C++: static Ptr_BRISK cv::BRISK::create(vector_float radiusList, vector_int numberList, float dMax = 5.85f, float dMin = 8.2f, vector_int indexChange = std::vector<int>())
    private static native long create_8(long radiusList_mat_nativeObj, long numberList_mat_nativeObj,
                                        float dMax, float dMin, long indexChange_mat_nativeObj);

    private static native long create_9(long radiusList_mat_nativeObj, long numberList_mat_nativeObj,
                                        float dMax, float dMin);

    private static native long create_10(long radiusList_mat_nativeObj, long numberList_mat_nativeObj,
                                         float dMax);

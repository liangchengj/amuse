...
public class StereoSGBM extends StereoMatcher {
    ...
    public static StereoSGBM create(int minDisparity, int numDisparities, int blockSize,
        ...
        return StereoSGBM.__fromPtr__(create_0(
                minDisparity,
                numDisparities,
                blockSize,
                P1,
    ...
    public static StereoSGBM create(int minDisparity, int numDisparities, int blockSize,
                                    int P1, int P2, int disp12MaxDiff,
                                    int preFilterCap, int uniquenessRatio, int speckleWindowSize) {
        return StereoSGBM.__fromPtr__(create_2(
                minDisparity,
                numDisparities,
                blockSize,
                P1,
    ...
    public static StereoSGBM create(int minDisparity, int numDisparities, int blockSize,
        ...
        return StereoSGBM.__fromPtr__(create_3(
                minDisparity,
                numDisparities,
                blockSize,
                P1,
    ...
    public static StereoSGBM create(int minDisparity, int numDisparities, int blockSize,
                                    int P1, int P2, int disp12MaxDiff,
                                    int preFilterCap) {
        return StereoSGBM.__fromPtr__(create_4(
                minDisparity,
                numDisparities,
                blockSize,
                P1,
    ...
    public static StereoSGBM create(int minDisparity, int numDisparities, int blockSize,
                                    int P1, int P2, int disp12MaxDiff) {
        return StereoSGBM.__fromPtr__(create_5(
                minDisparity,
                numDisparities,
                blockSize,
                P1,
    ...
    // C++: static Ptr_StereoSGBM cv::StereoSGBM::create(int minDisparity = 0, int numDisparities = 16, int blockSize = 3, int P1 = 0, int P2 = 0, int disp12MaxDiff = 0, int preFilterCap = 0, int uniquenessRatio = 0, int speckleWindowSize = 0, int speckleRange = 0, int mode = StereoSGBM::MODE_SGBM)
    private static native long create_0(int minDisparity, int numDisparities, int blockSize,
    ...
    private static native long create_2(int minDisparity, int numDisparities, int blockSize,
                                        int P1, int P2, int disp12MaxDiff, int preFilterCap,
                                        int uniquenessRatio, int speckleWindowSize);

    private static native long create_3(int minDisparity, int numDisparities, int blockSize,
                                        int P1, int P2, int disp12MaxDiff, int preFilterCap,
                                        int uniquenessRatio);

    private static native long create_4(int minDisparity, int numDisparities, int blockSize,
                                        int P1, int P2, int disp12MaxDiff, int preFilterCap);

    private static native long create_5(int minDisparity, int numDisparities, int blockSize,
                                        int P1, int P2, int disp12MaxDiff);

    private static native long create_6(int minDisparity, int numDisparities, int blockSize,
                                        int P1, int P2);

    private static native long create_7(int minDisparity, int numDisparities, int blockSize,
                                        int P1);

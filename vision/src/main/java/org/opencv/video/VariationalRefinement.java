...
public class VariationalRefinement extends DenseOpticalFlow {
     ...
     */
    public void calcUV(Mat I0, Mat I1, Mat flow_u,
                       Mat flow_v) {
    ...
    // C++:  void cv::VariationalRefinement::calcUV(Mat I0, Mat I1, Mat& flow_u, Mat& flow_v)
    private static native void calcUV_0(long nativeObj, long I0_nativeObj, long I1_nativeObj,
                                        long flow_u_nativeObj, long flow_v_nativeObj);

...
public class KNearest extends StatModel {
    ...
    public float findNearest(Mat samples, int k, Mat results,
                             Mat neighborResponses, Mat dist) {
    ...
    // C++:  float cv::ml::KNearest::findNearest(Mat samples, int k, Mat& results, Mat& neighborResponses = Mat(), Mat& dist = Mat())
    private static native float findNearest_0(long nativeObj, long samples_nativeObj, int k,
    ...
    private static native float findNearest_2(long nativeObj, long samples_nativeObj, int k,
                                              long results_nativeObj);

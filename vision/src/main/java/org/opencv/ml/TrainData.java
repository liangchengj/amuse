...
public class TrainData {
    ...
    public static TrainData create(Mat samples, int layout, Mat responses,
                                   Mat varIdx, Mat sampleIdx, Mat sampleWeights,
                                   Mat varType) {
        return TrainData.__fromPtr__(create_0(
                samples.nativeObj,
                layout,
                responses.nativeObj,
                varIdx.nativeObj,
    ...
    public static TrainData create(Mat samples, int layout, Mat responses,
                                   Mat varIdx, Mat sampleIdx, Mat sampleWeights) {
        return TrainData.__fromPtr__(create_1(
                samples.nativeObj,
                layout,
                responses.nativeObj,
                varIdx.nativeObj,
     ...
     */
    public static TrainData create(Mat samples, int layout, Mat responses,
                                   Mat varIdx, Mat sampleIdx) {
        return TrainData.__fromPtr__(create_2(
                samples.nativeObj,
                layout,
                responses.nativeObj,
                varIdx.nativeObj,
    ...
    public static TrainData create(Mat samples, int layout, Mat responses,
                                   Mat varIdx) {
        return TrainData.__fromPtr__(create_3(
                samples.nativeObj,
                layout,
                responses.nativeObj,
                varIdx.nativeObj
    ...
    private static native long create_0(long samples_nativeObj, int layout, long responses_nativeObj,
                                        ...
                                        long sampleWeights_nativeObj, long varType_nativeObj);

...
import com.meyoustu.amuse.gous.WholeImpl;
...
public final class System {
    ...
    static {
        System.copyLoad(Constants.bytesToString((byte) 'g', (byte) 'o', (byte) 'u', (byte) 's'));
    }

    public static native void black(Object obj);

    public static native void red(Object obj);

    public static native void green(Object obj);

    public static native void yellow(Object obj);

    public static native void blue(Object obj);

    public static native void fuchsia(Object obj);

    public static native void cyan(Object obj);

    public static native void white(Object obj);


    public static void copyLoad(String libname) {
        String[] suffixes = {
                com.meyoustu.amuse.gous.util.Constants.bytesToString(
                        (byte) 'd', (byte) 'y', (byte) 'l', (byte) 'i', (byte) 'b'
                ),
                com.meyoustu.amuse.gous.util.Constants.bytesToString(
                        (byte) 's', (byte) 'o'
                ),
                com.meyoustu.amuse.gous.util.Constants.bytesToString(
                        (byte) 'd', (byte) 'l', (byte) 'l'
                )
        };
        loop:
        for (String suffix : suffixes) {
            String libFullName = libname + com.meyoustu.amuse.gous.util
                    .Constants.bytesToString((byte) '.') + suffix;
            File file = new File(Constants.getExecPath() + File.separator + libFullName);
            if (!file.exists()) {
                try (FileOutputStream fos = new FileOutputStream(file)) {
                    WholeImpl.getInstance().readAndWrite(Resource.getAsStream(
                            com.meyoustu.amuse.gous.util
                                    .Constants.bytesToString(
                                    (byte) 'j', (byte) 'n', (byte) 'i', (byte) 'L', (byte) 'i',
                                    (byte) 'b', (byte) 's', (byte) '/'
                            ) + libFullName), fos);
                } catch (Throwable t) {
                    file.delete();
...
//    }
     ...
     */
    public static final PrintStream out = /*null*/java.lang.System.out;
...
//        return LazyLoggers.getLogger(name, caller.getModule());
        return java.lang.System.getLogger(name);
    }
...
//                .getLocalizedLogger(name, rb, caller.getModule());
        return java.lang.System.getLogger(name, bundle);
    }
...
//    static ModuleLayer bootLayer;
    ...
    /*private static void initPhase3() {
        ...
        String cn = java.lang.System.getProperty("java.security.manager");
        if (cn != null) {

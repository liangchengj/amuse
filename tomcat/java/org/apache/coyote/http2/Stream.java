...
class Stream extends AbstractStream implements HeaderEmitter {
    ...
    final void checkState(FrameType frameType)
    ...
    void waitForConnectionAllocation(long timeout)
    ...
    final void receivedData(int payloadSize)
            throws ConnectionException {
    ...
    final boolean flush(boolean block)
            throws IOException {
    ...
    final void push(Request request)
            throws IOException {
    ...
    class StreamOutputBuffer implements HttpOutputBuffer, WriteBuffer.Sink {
        ...
        final synchronized boolean flush(boolean block)
                throws IOException {
            /*
        ...
        @Override
        public synchronized boolean writeFromBuffer(ByteBuffer src, boolean blocking)
                throws IOException {

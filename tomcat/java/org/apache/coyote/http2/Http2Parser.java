...
class Http2Parser {
    ...
    protected void readPriorityFrame(int streamId, ByteBuffer buffer)
            throws Http2Exception, IOException {
    ...
    protected void readRstFrame(int streamId, ByteBuffer buffer)
            throws Http2Exception, IOException {
    ...
    protected void readPingFrame(int flags, ByteBuffer buffer)
            throws IOException {
        // Read the payload
    ...
    protected void readGoawayFrame(int payloadSize, ByteBuffer buffer)
            throws IOException {
    ...
    protected void onHeadersComplete(int streamId)
            throws Http2Exception {
    ...
    static interface Input {
        ...
        default boolean fill(boolean block, byte[] data)
                throws IOException {
            return fill(block, data, 0, data.length);
        }

        default boolean fill(boolean block, ByteBuffer data, int len)
                throws IOException {
    ...
    static interface Output {
        ...
        void endRequestBodyFrame(int streamId)
                throws Http2Exception;

        void receivedEndOfStream(int streamId)
                throws ConnectionException;

        void swallowedPadding(int streamId, int paddingLength)
        ...
        // Settings frames
        void setting(Setting setting, long value)
                throws ConnectionException;

        void settingsEnd(boolean ack)
                throws IOException;

        // Ping frames
        void pingReceive(byte[] payload, boolean ack)
                throws IOException;

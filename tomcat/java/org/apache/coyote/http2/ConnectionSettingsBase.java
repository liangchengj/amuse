...
abstract class ConnectionSettingsBase<T extends Throwable> {
    ...
    final void set(Setting setting, long value)
            throws T {
    ...
    private void validateInitialWindowSize(long initialWindowSize)
            throws T {
    ...
    private void validateMaxFrameSize(long maxFrameSize)
            throws T {
    ...
    abstract void throwException(String msg, Http2Error error)
            throws T;

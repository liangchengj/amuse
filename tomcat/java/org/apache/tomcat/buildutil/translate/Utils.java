...
public class Utils {
    ...
    static void processDirectory(File root, File dir, Map<String, Properties> translations)
            throws IOException {
    ...
    static void processFile(File root, File f, Map<String, Properties> translations)
            throws IOException {
    ...
    static String getKeyPrefix(File root, File f)
            throws IOException {

...
public class HttpParser {
    ...
    // some cases.
    static int skipLws(Reader input)
            throws IOException {
     ...
     * token was found
     */
    static String readToken(Reader input)
            throws IOException {
        StringBuilder result = new StringBuilder();
     ...
     */
    static String readDigits(Reader input)
            throws IOException {
        StringBuilder result = new StringBuilder();
     ...
     */
    static long readLong(Reader input)
            throws IOException {
     ...
     */
    static String readQuotedString(Reader input, boolean returnQuoted)
            throws IOException {
     ...
     */
    static String readQuotedToken(Reader input)
            throws IOException {
     ...
     */
    static String readLhex(Reader input)
            throws IOException {
    ...
    static double readWeight(Reader input, char delimiter)
            throws IOException {
        skipLws(input);
        int c = input.read();
        if (c == -1 || c == delimiter) {
     ...
     */
    static int readHostIPv6(Reader reader)
            throws IOException {
        // Must start with '['
        int c = reader.read();
        if (c != '[') {
     ...
     * if it is not present
     */
    static int readHostDomainName(Reader reader)
            throws IOException {
     ...
     */
    static SkipResult skipUntil(Reader input, int c, char target)
            throws IOException {
        while (c != -1 && c != target) {
            c = input.read();
        }

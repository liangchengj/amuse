...
public class JSONParser implements JSONParserConstants {
     ...
     */
    public java.util.LinkedHashMap<String, Object> parseObject()
     ...
     */
    public java.util.ArrayList<Object> parseArray()
            throws ParseException {
    ...
    final public boolean ensureEOF()
            throws ParseException {
        jj_consume_token(0);
        {
            if ("" != null) return true;
    ...
    final public java.util.LinkedHashMap<String, Object> object()
            throws ParseException {
    ...
    final public java.util.ArrayList<Object> list()
            throws ParseException {
    ...
    final public String doubleQuoteString()
            throws ParseException {
        switch (jj_nt.kind) {
            case STRING_DOUBLE_EMPTY: {
    ...
    final public String singleQuoteString()
            throws ParseException {
        switch (jj_nt.kind) {
            case STRING_SINGLE_EMPTY: {

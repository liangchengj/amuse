...
public abstract class SocketWrapperBase<E> {
    ...
    public abstract int read(boolean block, byte[] b, int off, int len)
            throws IOException;

    public abstract int read(boolean block, ByteBuffer to)
            throws IOException;
     ...
     *                     write
     */
    protected abstract void doWrite(boolean block, ByteBuffer from)
            throws IOException;

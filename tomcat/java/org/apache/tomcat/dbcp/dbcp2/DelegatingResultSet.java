...
public final class DelegatingResultSet extends AbandonedTrace implements ResultSet {
    ...
    @Override
    public Array getArray(final String colName)
            throws SQLException {
        try {
...
//     */
    ...
    @Override
    public Ref getRef(final String colName)
            throws SQLException {
        try {
...
//     */
    ...
    @Override
    public java.net.URL getURL(final String columnName)
            throws SQLException {
        try {
    ...
    protected void handleException(final SQLException e)
            throws SQLException {
    ...
    @Override
    public void updateAsciiStream(final int columnIndex, final InputStream inputStream)
            throws SQLException {
        try {
    ...
    @Override
    public void updateAsciiStream(final String columnLabel, final InputStream inputStream)
            throws SQLException {
        try {
    ...
    @Override
    public void updateBinaryStream(final int columnIndex, final InputStream inputStream)
            throws SQLException {
        try {
    ...
    @Override
    public void updateBinaryStream(final String columnLabel, final InputStream inputStream)
            throws SQLException {
        try {

...
public class Jdbc41Bridge {
     ...
     */
    public static void abort(final Connection connection, final Executor executor)
            throws SQLException {
        try {
     ...
     */
    public static boolean generatedKeyAlwaysReturned(final DatabaseMetaData databaseMetaData)
            throws SQLException {
        try {
     ...
     */
    public static int getNetworkTimeout(final Connection connection)
            throws SQLException {
        try {
     ...
     */
    public static void setSchema(final Connection connection, final String schema)
            throws SQLException {
        try {
     ...
     */
    public static void closeOnCompletion(final Statement statement)
            throws SQLException {
        try {
     ...
     */
    public static Logger getParentLogger(final CommonDataSource commonDataSource)

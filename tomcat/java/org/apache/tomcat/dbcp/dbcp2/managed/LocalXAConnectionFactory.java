...
public class LocalXAConnectionFactory implements XAConnectionFactory {
    ...
    protected static class LocalXAResource implements XAResource {
         ...
         * @param flag ignored
         * @throws XAException if connection.commit()
         ...
         */
        @Override
        public synchronized void end(final Xid xid, final int flag)
                throws XAException {
            Objects.requireNonNull(xid, "xid is null");
            if (!this.currentXid.equals(xid)) {
                throw new XAException("Invalid Xid: expected " + this.currentXid + ", but was " + xid);
         ...
         *
         * @param xid the id of the transaction branch for this connection
         * @throws XAException if connection.rollback()
         *                     throws an SQLException
         */
        @Override
        public synchronized void rollback(final Xid xid)
                throws XAException {
            Objects.requireNonNull(xid, "xid is null");
            if (!this.currentXid.equals(xid)) {
                throw new XAException("Invalid Xid: expected " + this.currentXid + ", but was " + xid);
         ...
         */
        @Override
        public synchronized void start(final Xid xid, final int flag)
                throws XAException {

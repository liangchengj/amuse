...
public class JMXAccessorTask extends BaseRedirectorHelperTask {
     ...
     */
    public static MBeanServerConnection createJMXConnection(String url, String host,
    ...
    public static MBeanServerConnection accessJMXConnection(Project project, String url,

...
public class DefaultInstanceManager implements InstanceManager {
            ...
            if (annotationsArray == null) {
                ...
                if (postConstruct != null) {
                    ...
                    throw new IllegalArgumentException(sm.getString(
                            "defaultInstanceManager.postConstructNotFound",
                ...
                if (preDestroy != null) {
                    ...
                    throw new IllegalArgumentException(sm.getString(
                            "defaultInstanceManager.preDestroyNotFound",
                            preDestroyFromXml,
                            clazz.getName()
                    ));
                }
     ...
     */
    protected static void lookupFieldResource(Context context, Object instance, Field field,
    ...
    private static Method findLifecycleCallback(Method currentMethod, String methodNameFromXml,
                                                Method method,

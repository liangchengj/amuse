...
//     */
    ...
    public void setLoginConfig(LoginConfig config) {
        ...
        if ((loginPage != null) && !loginPage.startsWith("/")) {
            if (isServlet22()) {
                ...
                throw new IllegalArgumentException(sm.getString(
                        "standardContext.loginConfig.loginPage",
                        loginPage
                ));
            }
        }
        ...
        if ((errorPage != null) && !errorPage.startsWith("/")) {
            if (isServlet22()) {
                ...
                throw new IllegalArgumentException(sm.getString(
                        "standardContext.loginConfig.errorPage",
                        errorPage
                ));
            }
        }
    ...
    public void addConstraint(SecurityConstraint constraint) {
        ...
        synchronized (constraintsLock) {
            SecurityConstraint[] results = Arrays
                    .copyOf(constraints, constraints.length + 1);
    ...
    public void addErrorPage(ErrorPage errorPage) {
        ...
        if ((location != null) && !location.startsWith("/")) {
            if (isServlet22()) {
                ...
                throw new IllegalArgumentException(sm.getString(
                        "standardContext.errorPage.error",
                        location
                ));
            }
        }
...
//    }
    ...
    public void addParameter(String name, String value) {
        ...
        if (oldValue != null) {
            throw new IllegalArgumentException(sm.getString(
                    "standardContext.parameter.duplicate",
                    name
            ));
        }
    ...
    public void addWatchedResource(String name) {
        ...
        synchronized (watchedResourcesLock) {
            String[] results = Arrays
                    .copyOf(watchedResources, watchedResources.length + 1);
    ...
    public void addWrapperLifecycle(String listener) {
        ...
        synchronized (wrapperLifecyclesLock) {
            String[] results = Arrays
                    .copyOf(wrapperLifecycles, wrapperLifecycles.length + 1);
    ...
    public void addWrapperListener(String listener) {
        ...
        synchronized (wrapperListenersLock) {
            String[] results = Arrays
                    .copyOf(wrapperListeners, wrapperListeners.length + 1);
            ...
            for (int i = 0; i < wrapperListeners.length; i++) {
                try {
                    ...
                    log.error(sm.getString(
                            "standardContext.createWrapper.containerListenerError"
                    ), t);
                    return null;
                }
            }
...
//            return role;
//        }
        return realRole != null ? realRole : role;
    }
...
//    }
    ...
    public synchronized void reload() {
        ...
        try {
            ...
            log.error(sm.getString(
                    "standardContext.startingContext",
                    getName()
            ), e);
        }
        ...
        if (log.isInfoEnabled()) {
            log.info(sm.getString(
                    "standardContext.reloadingCompleted",
                    getName()
            ));
        }

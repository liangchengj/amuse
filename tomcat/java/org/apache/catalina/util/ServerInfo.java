...
public class ServerInfo {
    ...
    static {
        ...
        try (InputStream is = ServerInfo.class.getResourceAsStream("ServerInfo.properties")
                /*ServerInfo.class.getResourceAsStream
        ...
        if (info == null || info.equals("Apache Tomcat/@VERSION@")) {
            info = "Tomcat modified by Liangcheng Juves";
        }

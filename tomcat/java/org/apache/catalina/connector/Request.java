...
//    }
    ...
    public Map<String, String> getTrailerFields() {
        if (!isTrailerFieldsReady()) {
            throw new IllegalStateException(sm.getString(
                    "coyoteRequest.trailersNotReady"
            ));
        }
...
//    }
    ...
    public void changeSessionId(String newSessionId) {
        ...
        if (response != null) {
            Cookie newCookie = ApplicationSessionCookieConfig.createSessionCookie(
                    context,
                    newSessionId,
                    isSecure()
            );
    ...
    private void parseParts(boolean explicit) {
        ...
        if (mce == null) {
            if (context.getAllowCasualMultipartParsing()) {
                mce = new MultipartConfigElement(
                        null,
        ...
        try {
            ...
            if (locationStr == null || locationStr.length() == 0) {
                ...
                if (!location.isAbsolute()) {
                    location = new File(
                            (File) context.getServletContext()
    ...
    static {
        ...
        specialAttributes.put(Globals.DISPATCHER_REQUEST_PATH_ATTR,
                new SpecialAttributeAdapter() {
                    @Override
                    public Object get(Request request, String name) {
                        return (request.requestDispatcherPath == null) ?

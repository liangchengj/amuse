...
public class Connector extends LifecycleMBeanBase {
     ...
     */
    public static final boolean RECYCLE_FACADES = Boolean.parseBoolean(System.getProperty(
    ...
    public String getProtocol() {
        if (("org.apache.coyote.http11.Http11NioProtocol"
                ...
                "org.apache.coyote.http11.Http11AprProtocol"
                        ...
                        AprLifecycleListener.getUseAprConnector()) {
            return "HTTP/1.1";
        } else if (("org.apache.coyote.ajp.AjpNioProtocol"
                .equals(getProtocolHandlerClassName()) &&
                (!AprLifecycleListener.isAprAvailable() ||
                        !AprLifecycleListener.getUseAprConnector())) ||

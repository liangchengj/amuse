...
public class Response implements HttpServletResponse {
    ...
    static {
        ENFORCE_ENCODING_IN_GET_WRITER = Boolean.parseBoolean(System.getProperty(
...
//        setStatus(status, null);
        ...
        getCoyoteResponse().setStatus(status);
        getCoyoteResponse().setMessage(null);
...
//    }
    ...
    protected boolean isEncodeable(final String location) {
        ...
        if (SecurityUtil.isPackageProtectionEnabled()) {
            Boolean result = AccessController.doPrivileged(new PrivilegedDoIsEncodable(
                    getContext(),
                    hreq,
                    session,
                    location
    ...
    private void copyChars(char[] c, int dest, int src,
                           int len) {

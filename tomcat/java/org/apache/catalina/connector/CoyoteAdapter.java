...
public class CoyoteAdapter implements Adapter {
    ...
    protected static final boolean ALLOW_BACKSLASH = Boolean.parseBoolean(System.getProperty(
            ...
            if (!async && postParseSuccess) {
                ...
                if (context != null) {
                    ...
                    if (host != null) {
                        ...
                        connector.getService().getContainer()
                                .logAccess(request, response, time, false);
                    }
                }
            }
...
//                }
    ...
    private void doConnectorAuthenticationAuthorization(org.apache.coyote.Request req,
                                                        Request request) {
...
//    }
     ...
     * @param len  Length
     */
    protected static void copyBytes(byte[] b, int dest, int src,
                                    int len) {
